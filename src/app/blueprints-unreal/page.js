...
export default function UnrealBlueprintsPage() {
  const router = useRouter(); // Init useRouter hook
    ...
    <main className="pt-[80px] min-h-screen bg-black text-white flex flex-col">
      ...
      <section className="flex-grow max-w-7xl mx-auto w-full px-6 sm:px-12 md:px-20 backdrop-blur-2xl py-12 z-10">
        ...
        <div className="rounded-lg p-6 backdrop-blur-md mb-8">
          <h2 className="text-3xl font-ovo mb-4 text-center">Zombie Wave System & Logic</h2>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-6"
               style={{ minHeight: '400px' }}>
            
            
          <img src="/BlueprintCodeSnippets/AiSpawnerLogic1.png"
           alt="Blueprint Showcase 1" 
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/AiSpawnerLogic2.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
        ...
        <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/AiSpawnerLogic3.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/AiSpawnerLogic4.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/AiSpawnerLogic5.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/AiSpawnerLogic6.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
        ...
        <h1 className="text-5xl font-ovo mb-12 text-center">Code Analysis</h1>
        ...
        <div className="rounded-lg p-6 backdrop-blur-md mb-8">
          <h2 className="text-3xl font-ovo mb-4 mt-8 text-center">Modular Weapon System</h2>
          <p className="text-lg text-center text-gray-300 font-ovo mb-6">
          ...
          <img src="/BlueprintCodeSnippets/WeaponfiringlogicHigherRes2.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/ReducingAmmo.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
        ...
        <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/Reloadinglogic.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/proceduralrecoil.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/controllerrecoil.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/AimingTimeline.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/Aiminginterp.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
        </div>
        ...
        <div className="rounded-lg p-6 backdrop-blur-md mb-8">
          <h2 className="text-3xl font-ovo mb-4 mt-8 text-center">Interactive Door System</h2>
          <p className="text-lg text-center text-gray-300 font-ovo mb-6">
          ...
          <img src="/BlueprintCodeSnippets/InteractiveDoorLogic.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
          ...
          <div className="w-full h-[60vh]  rounded-lg overflow-hidden flex items-center justify-center text-gray-400 text-lg mb-12"
            ...
            <img src="/BlueprintCodeSnippets/InteractiveDoorHUDLogic.png"
           alt="Blueprint Showcase 1" 
          className="w-full h-full object-cover" />
          </div>
